...
public class SQLSetup extends DatabaseSetup
{
	public SQLSetup(MIM plugin, boolean adm, String path, String databaseType)
	{
		...
		init(databaseType, host, port, database, user, password, isAutoConnect, isVerifyServerCertificate, isSSLEnabled);
		loadDatabaseSetup(ServerType.SPIGOT);
	}
}